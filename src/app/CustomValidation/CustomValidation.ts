...
export const errorMessages: { [key: string]: string } = {
    ...
    Password: 'Password must contains 6 characters or longer with 1 upper case letter,numbers and special characters.',
    confirmPassword: 'Passwords must match',
    MobileNo: 'Please enter valid mobile number',
    OTP:'OTP must be 6 numeric characters',
    LoginId: 'Login id must be must contains 6 characters with alphabets or numeber only.',
